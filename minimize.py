...
def minimize(X, obj_func, args, maxnumlinesearch=None, maxnumfuneval=None, red=1.0, verbose=True):
    ...
    f0, df0 = obj_func(X, *args)                          # get function value and gradient
    fX = [f0]
